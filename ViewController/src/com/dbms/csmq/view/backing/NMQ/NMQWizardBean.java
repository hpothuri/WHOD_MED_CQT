    ...
    */
    ...
    public boolean saveDetails (boolean silent) {
        ...
        if (mode == CSMQBean.MODE_IMPACT_ASSESSMENT) {
            ...
            results = NMQUtils.saveIADetails(tempName, currentProduct, currentTermLevel, currentScope, currentMQALGO, currentMQCRTEV, currentMQGROUP, currentContentCode, this.getUpdateParam(), currentRequestor, currentDictContentID, userBean.getUserRole(), action); 
            }
        /*
         * @author MTW
         * 06/30/2014
         ...
         */
            ...
            if (designeeList != null) designeeListString = designeeList.toString();
    ...
    public String updateRelations() {
        ...
        if (this.currentStatus.equals(CSMQBean.PENDING_RELEASE_STATUS)) tGroup = this.currentPredictGroups;
