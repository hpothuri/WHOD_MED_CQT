...
public class WhodWorkflowBean {
    ...
    public WhodWorkflowBean() {
        ...
        nMQWizardBean = (WhodWizardBean)ADFContext.getCurrent().getPageFlowScope().get("WhodWizardBean");
    ...
    public void activate(DialogEvent actionEvent) {
        WhodUtils.activateGroup(CSMQBean.getProperty("DEFAULT_PUBLISH_RELEASE_GROUP"));
    }
